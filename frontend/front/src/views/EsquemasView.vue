...
<div class="container">
    <div class="row">
        <div class="col-10">
            <h6 class="display-6 text-center">Configuracion de vacunas en el esquema</h6>
        </div>
...
export default {
    ...
    methods: {
        mostrar(esquema) {
            ...
            if (esquema) {
                this.titulot = "Editar", this.titulob = "Editar"
            } else {
                this.titulot = "Agregar Nueva", this.titulob = "Guardar"
            }
        }
